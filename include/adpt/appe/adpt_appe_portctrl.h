...
#if defined(HMSPPE)
#define HMSPPE_PORT4_MUX_PCS_UNIPHY0			0x0
#define HMSPPE_PORT4_MUX_PCS_INTERNAL_PHY		0x1
#define HMSPPE_PORT5_MUX_PCS_INTERNAL_PHY		0x0
#define HMSPPE_PORT5_MUX_PCS_UNIPHY1			0x1
#endif
sw_error_t
