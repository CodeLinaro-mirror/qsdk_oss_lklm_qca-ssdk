...
#define SW_API_PT_SWITCH_LOOPBACK_PORT_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_SWITCH_LOOPBACK_PORT_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_SWITCH_LOOPBACK_PORT_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Port ID"),

#define SW_API_PT_VCH_BP_STATS_GET_DESC \
	SW_PARAM_DEF(SW_API_PT_VCH_BP_STATS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
	SW_PARAM_DEF(SW_API_PT_VCH_BP_STATS_GET, SW_UINT32, 4, SW_PARAM_IN, "VCH ID"), \
	SW_PARAM_DEF(SW_API_PT_VCH_BP_STATS_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "STATS"),

#define SW_API_PT_PPS_CTRL_SET_DESC \
    SW_PARAM_DEF(SW_API_PT_PPS_CTRL_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_PPS_CTRL_SET, SW_PT_PPS_CTRL, \
		    sizeof(fal_port_pps_ctrl_t), SW_PARAM_PTR|SW_PARAM_IN, "PPS Ctrl"),

#define SW_API_PT_PPS_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_PPS_CTRL_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_PPS_CTRL_GET, SW_PT_PPS_CTRL, \
		    sizeof(fal_port_pps_ctrl_t), SW_PARAM_PTR|SW_PARAM_OUT, "PPS Ctrl"),

#define SW_API_PT_FASTRETRAIN_CFG_SET_DESC \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_CFG_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_CFG_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_CFG_SET, SW_PORT_FR_CFG, \
		sizeof(fal_port_fr_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "Fast Retrain Cfg"),

#define SW_API_PT_FASTRETRAIN_CFG_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_CFG_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_CFG_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_CFG_GET, SW_PORT_FR_CFG, \
		sizeof(fal_port_fr_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "Fast Retrain Cfg"),

#define SW_API_PT_FASTRETRAIN_STATUS_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_STATUS_GET, SW_PORT_FR_STATUS, \
		sizeof(fal_port_fr_status_t), SW_PARAM_PTR|SW_PARAM_OUT, "Fast Retrain Status"),

#define SW_API_PT_FASTRETRAIN_TRIGGER_DESC \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_TRIGGER, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_FASTRETRAIN_TRIGGER, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),
...
#define SW_API_PT_VLAN_TRANS_ADV_SET_DESC \
	...
	SW_PARAM_DEF(SW_API_PT_VLAN_TRANS_ADV_SET, SW_PT_VLAN_TRANS_ADV_RULE_WITH_PORT, \
			sizeof(fal_vlan_trans_adv_rule_t), SW_PARAM_PTR|SW_PARAM_IN, \
			"vlan trans rule"), \
...
#define SW_API_FDB_AGE_CTRL_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_AGE_CTRL_SET, SW_FDB_AGE_CTRL, sizeof(fal_fdb_age_ctrl_t), \
    SW_PARAM_IN, "Age"),

#define SW_API_FDB_AGE_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_FDB_AGE_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_AGE_CTRL_GET, SW_FDB_AGE_CTRL, sizeof(fal_fdb_age_ctrl_t), \
    SW_PARAM_PTR|SW_PARAM_OUT, "Age"),

#define SW_API_FDB_LEARN_CTRL_SET_DESC \
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_SET, SW_FDB_LEARN_CTRL, \
    sizeof(fal_fdb_learning_ctrl), SW_PARAM_IN, "Learn Ctrl"),

#define SW_API_FDB_LEARN_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_GET, SW_FDB_LEARN_CTRL, \
    sizeof(fal_fdb_learning_ctrl), SW_PARAM_PTR|SW_PARAM_OUT, "Learn Ctrl"),
...
#define SW_API_ACL_RULE_PRIORITY_SET_DESC \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "List ID"), \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Rule ID"), \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Priority"), \

#define SW_API_ACL_RULE_PRIORITY_GET_DESC \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "List ID"), \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Rule ID"), \
    SW_PARAM_DEF(SW_API_ACL_RULE_PRIORITY_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_PTR|SW_PARAM_OUT, "Priority"), \

#define SW_API_ACL_DSCP_PCP_MAPPING_SET_DESC \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_SET, SW_UINT8, \
			sizeof(a_uint8_t), SW_PARAM_IN, "Group ID"), \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_SET, SW_UINT8, \
			sizeof(a_uint8_t), SW_PARAM_IN, "Dscp"), \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_SET, SW_UINT8, \
...
#define SW_API_ACL_DSCP_PCP_MAPPING_GET_DESC \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_GET, SW_UINT8, \
			sizeof(a_uint8_t), SW_PARAM_IN, "Group ID"), \
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_GET, SW_UINT8, \
			sizeof(a_uint8_t), SW_PARAM_IN, "Dscp"),\
	SW_PARAM_DEF(SW_API_ACL_DSCP_PCP_MAPPING_GET, SW_UINT8, \
...
#define SW_API_QOS_PORT_PCP_CFG_SET_DESC \
    SW_PARAM_DEF(SW_API_QOS_PORT_PCP_CFG_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_QOS_PORT_PCP_CFG_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),\
    SW_PARAM_DEF(SW_API_QOS_PORT_PCP_CFG_SET, SW_PCP_CFG, \
		    sizeof(fal_qos_pcp_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "Pcpcfg"),

#define SW_API_QOS_PORT_PCP_CFG_GET_DESC \
    SW_PARAM_DEF(SW_API_QOS_PORT_PCP_CFG_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_QOS_PORT_PCP_CFG_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),\
    SW_PARAM_DEF(SW_API_QOS_PORT_PCP_CFG_GET, SW_PCP_CFG, \
		    sizeof(fal_qos_pcp_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "Pcpcfg"),
...
#define SW_API_VSI_TBL_DUMP_DESC \
    ...
    SW_PARAM_DEF(SW_API_VSI_TBL_DUMP, SW_UINT32, 4, SW_PARAM_IN, "VSI ID"), \
    SW_PARAM_DEF(SW_API_VSI_TBL_DUMP, SW_VSI_TBL_INFO, sizeof(ref_vsi_info_t), SW_PARAM_PTR|SW_PARAM_OUT, "VSI table"),
...
#define SW_API_QM_COUNTER_MONITOR_EN_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_EN_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_EN_SET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_IN, "enable"),

#define SW_API_QM_COUNTER_MONITOR_EN_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_EN_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_EN_GET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "enable"),

#define SW_API_QM_COUNTER_MONITOR_STATS_CLEANUP_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATS_CLEANUP, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),

#define SW_API_QM_COUNTER_MONITOR_STATUS_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "type id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "cnt id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATUS_GET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "enable"),

#define SW_API_QM_COUNTER_MONITOR_MAP_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "type id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "map id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_SET, SW_MONITOR_MAP, \
		    sizeof(fal_qm_monitor_map_t), SW_PARAM_PTR|SW_PARAM_IN, \
		    "monitor map"),

#define SW_API_QM_COUNTER_MONITOR_MAP_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "type id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "map id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_MAP_GET, SW_MONITOR_MAP, \
		    sizeof(fal_qm_monitor_map_t), SW_PARAM_PTR|SW_PARAM_OUT, \
		    "monitor map"),

#define SW_API_QM_COUNTER_MONITOR_CTRL_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_SET, SW_UINT32, 4, SW_PARAM_IN, "type id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_SET, SW_UINT32, 4, SW_PARAM_IN, "cnt id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_SET, SW_MONITOR_CTRL, \
		    sizeof(fal_qm_monitor_ctrl_t), SW_PARAM_PTR|SW_PARAM_IN, \
		    "monitor ctrl"),

#define SW_API_QM_COUNTER_MONITOR_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "type id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "cnt id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_CTRL_GET, SW_MONITOR_CTRL, \
		    sizeof(fal_qm_monitor_ctrl_t), SW_PARAM_PTR|SW_PARAM_OUT, \
		    "monitor map"),

#define SW_API_QM_COUNTER_MONITOR_STATS_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATS_GET, SW_UINT32, 4, SW_PARAM_IN, "type id"), \
    SW_PARAM_DEF(SW_API_QM_COUNTER_MONITOR_STATS_GET, SW_UINT32, 4, SW_PARAM_IN, "cnt id"), \
...
#define SW_API_QM_TCONT_STAT_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_TCONT_STAT_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_TCONT_STAT_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "TCONT ID"), \
    SW_PARAM_DEF(SW_API_QM_TCONT_STAT_GET, SW_TCONT_STAT, \
...
#define SW_API_UCAST_QUEUE_DDRQ_EN_SET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_DDRQ_EN_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_DDRQ_EN_SET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_DDRQ_EN_SET, SW_DDRQ_EN, \
		    sizeof(fal_ucast_queue_ddrq_en_t), SW_PARAM_PTR|SW_PARAM_IN, "ddrqen"),

#define SW_API_UCAST_QUEUE_DDRQ_EN_GET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_DDRQ_EN_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_DDRQ_EN_GET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_DDRQ_EN_GET, SW_DDRQ_EN, \
		    sizeof(fal_ucast_queue_ddrq_en_t), SW_PARAM_PTR|SW_PARAM_OUT, "ddrqen"),

#define SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET, SW_UINT32, \
		    sizeof(fal_passthrough_mode_t), SW_PARAM_IN, "Passthrough Mode"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET, SW_PASSTHROUGH_SRC_PROFILE, \
		    sizeof(fal_passthrough_src_profile_t), SW_PARAM_PTR|SW_PARAM_IN, \
		    "Source profile"),

#define SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET, SW_UINT32, \
		    sizeof(fal_passthrough_mode_t), SW_PARAM_IN, "Passthrough Mode"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET, SW_PASSTHROUGH_SRC_PROFILE, \
		    sizeof(fal_passthrough_src_profile_t), SW_PARAM_PTR|SW_PARAM_OUT, \
		    "Source profile"),

#define SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET, SW_UINT32, \
		    sizeof(fal_passthrough_mode_t), SW_PARAM_IN, "Passthrough Mode"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_IN, "Enable"),

#define SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET, SW_UINT32, \
		    sizeof(fal_passthrough_mode_t), SW_PARAM_IN, "Passthrough Mode"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "Enable"),

#define SW_API_QM_PASSTHROUGH_CPUCODE_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_SET, SW_PASSTHROUGH_CPUCODE, \
		    sizeof(fal_passthrough_cpucode_t), SW_PARAM_PTR|SW_PARAM_IN, \
		    "Passthrough CPU Code"),

#define SW_API_QM_PASSTHROUGH_CPUCODE_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_GET, SW_PASSTHROUGH_CPUCODE, \
		    sizeof(fal_passthrough_cpucode_t), SW_PARAM_PTR|SW_PARAM_OUT, \
		    "Passthrough CPU Code"),

#define SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET, SW_UINT32, \
		    sizeof(fal_passthrough_mode_t), SW_PARAM_IN, "Passthrough Mode"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_IN, "Enable"),

#define SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET, SW_UINT32, \
		    sizeof(fal_passthrough_mode_t), SW_PARAM_IN, "Passthrough Mode"), \
    SW_PARAM_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "Enable"),

#define SW_API_QM_DEQUEUE_DROP_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_DEQUEUE_DROP_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_DEQUEUE_DROP_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "queue ID"), \
    SW_PARAM_DEF(SW_API_QM_DEQUEUE_DROP_SET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_IN, "dequeue drop en"),

#define SW_API_QM_DEQUEUE_DROP_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_DEQUEUE_DROP_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_DEQUEUE_DROP_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "queue ID"), \
...
#define SW_API_QM_MCAST_ENQUEUE_CTRL_SET_DESC \
    SW_PARAM_DEF(SW_API_QM_MCAST_ENQUEUE_CTRL_SET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_MCAST_ENQUEUE_CTRL_SET, SW_UINT32, \
		    sizeof(fal_port_t), SW_PARAM_IN, "Port ID"), \
    SW_PARAM_DEF(SW_API_QM_MCAST_ENQUEUE_CTRL_SET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_IN, "ucast_enqueue_en"),

#define SW_API_QM_MCAST_ENQUEUE_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_QM_MCAST_ENQUEUE_CTRL_GET, SW_UINT32, \
		    sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_QM_MCAST_ENQUEUE_CTRL_GET, SW_UINT32, \
		    sizeof(fal_port_t), SW_PARAM_IN, "Port ID"), \
    SW_PARAM_DEF(SW_API_QM_MCAST_ENQUEUE_CTRL_GET, SW_ENABLE, \
		    sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "ucast_enqueue_en"),
...
#define SW_API_TUNNEL_TUPLE_ENTRY_ADD_DESC \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_ADD, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_ADD, SW_TUNNEL_TUPLE_ENTRY, \
			sizeof(fal_tunnel_tuple_entry_t), SW_PARAM_PTR|SW_PARAM_IN, \
			"tunnel tuple Entry"),

#define SW_API_TUNNEL_TUPLE_ENTRY_DEL_DESC \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_DEL, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_DEL, SW_TUNNEL_TUPLE_ENTRY, \
			sizeof(fal_tunnel_tuple_entry_t), SW_PARAM_PTR|SW_PARAM_IN, \
			"tunnel tuple Entry"),

#define SW_API_TUNNEL_TUPLE_ENTRY_GETFIRST_DESC \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_GETFIRST, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_GETFIRST, SW_TUNNEL_TUPLE_ENTRY, \
			sizeof(fal_tunnel_tuple_entry_t), SW_PARAM_PTR|SW_PARAM_OUT, \
			"tunnel tuple Entry"),

#define SW_API_TUNNEL_TUPLE_ENTRY_GETNEXT_DESC \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_GETNEXT, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_TUNNEL_TUPLE_ENTRY_GETNEXT, SW_TUNNEL_TUPLE_ENTRY, \
			sizeof(fal_tunnel_tuple_entry_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, \
			"tunnel tuple Entry"),

#define SW_API_TUNNEL_DECAP_MISS_ACTION_SET_DESC \
	SW_PARAM_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_SET, SW_TUNNEL_TYPE, \
			sizeof(fal_tunnel_type_t), SW_PARAM_IN, "tunnel type"),\
	SW_PARAM_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_SET, SW_TUNNEL_DECAP_MISS_ACTION, \
			sizeof(fal_tunnel_decap_miss_action_t), SW_PARAM_PTR|SW_PARAM_IN, \
			"tunnel decap miss action"),

#define SW_API_TUNNEL_DECAP_MISS_ACTION_GET_DESC \
	SW_PARAM_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
	SW_PARAM_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_GET, SW_TUNNEL_TYPE, \
			sizeof(fal_tunnel_type_t), SW_PARAM_IN, "tunnel type"),\
	SW_PARAM_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_GET, SW_TUNNEL_DECAP_MISS_ACTION, \
			sizeof(fal_tunnel_decap_miss_action_t), SW_PARAM_PTR|SW_PARAM_OUT, \
			"tunnel decap miss action"),
...
#define SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Ath src port"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET, SW_DEST_INFO, \
			sizeof(fal_dest_info_t), SW_PARAM_IN|SW_PARAM_PTR, "Int dest info"),

#define SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Ath src port"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET, SW_DEST_INFO, \
			sizeof(fal_dest_info_t), SW_PARAM_OUT|SW_PARAM_PTR, "Int dest info"),

#define SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Ath dest port"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET, SW_DEST_INFO, \
			sizeof(fal_dest_info_t), SW_PARAM_IN|SW_PARAM_PTR, "Int dest info"),

#define SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Ath dest port"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET, SW_DEST_INFO, \
			sizeof(fal_dest_info_t), SW_PARAM_OUT|SW_PARAM_PTR, "Int dest info"),

#define SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Ath servcode"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Int servcode"),

#define SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Ath servcode"), \
	SW_PARAM_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_PTR|SW_PARAM_OUT, "Int servcode"),

#define SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Int src port"), \
	SW_PARAM_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Ath src port"),

#define SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET_DESC \
	SW_PARAM_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(a_uint32_t), SW_PARAM_IN, "Dev Id"), \
	SW_PARAM_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_IN, "Int src port"), \
	SW_PARAM_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET, SW_UINT32, \
			sizeof(fal_port_t), SW_PARAM_PTR|SW_PARAM_OUT, "Ath src port"),
...
#define SW_API_CROSSCHIP_BP_MODE_SET_DESC \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_MODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_MODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Mode"),

#define SW_API_CROSSCHIP_BP_MODE_GET_DESC \
	SW_PARAM_DEF(SW_API_CROSSCHIP_BP_MODE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
	SW_PARAM_DEF(SW_API_CROSSCHIP_BP_MODE_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Mode"),

#define SW_API_CROSSCHIP_BP_EN_SET_DESC \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_EN_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_EN_SET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_EN_SET, SW_ENABLE, 4, SW_PARAM_IN, "Enable"),

#define SW_API_CROSSCHIP_BP_EN_GET_DESC \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_EN_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_EN_GET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_CROSSCHIP_BP_EN_GET, SW_ENABLE, 4, \
		    SW_PARAM_PTR|SW_PARAM_OUT, "Enable"),
/* auto_insert_flag */
/*qca808x_start*/
