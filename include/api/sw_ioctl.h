...
#define SW_API_PT_SWITCH_LOOPBACK_PORT_GET	(101 + SW_API_PORT_OFFSET)
#define SW_API_PT_VCH_BP_STATS_GET	(102 + SW_API_PORT_OFFSET)
#define SW_API_PT_PPS_CTRL_SET       (103 + SW_API_PORT_OFFSET)
#define SW_API_PT_PPS_CTRL_GET       (104 + SW_API_PORT_OFFSET)
#define SW_API_PT_FASTRETRAIN_CFG_SET   (105 + SW_API_PORT_OFFSET)
#define SW_API_PT_FASTRETRAIN_CFG_GET   (106 + SW_API_PORT_OFFSET)
#define SW_API_PT_FASTRETRAIN_STATUS_GET (107 + SW_API_PORT_OFFSET)
#define SW_API_PT_FASTRETRAIN_TRIGGER   (108 + SW_API_PORT_OFFSET)

    /*vlan*/
#define SW_API_VLAN_OFFSET         140
#if SW_API_PT_FASTRETRAIN_TRIGGER >= SW_API_VLAN_OFFSET
#error "port API IDs overflow into VLAN space; update SW_API_VLAN_OFFSET"
#endif
...
#define SW_API_PT_ISOL_CTRL_SET		(76 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_CTRL_GET		(77 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_GROUP_SET	(78 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_GROUP_GET	(79 + SW_API_PORTVLAN_OFFSET)
...
#define SW_API_PT_VLAN_TRANS_ADV_SET	(82 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_VLAN_TRANS_ADV_GET	(83 + SW_API_PORTVLAN_OFFSET)
#define SW_API_VLAN_TRANS_DSCP_PCP_MAPPING_SET	(84 + SW_API_PORTVLAN_OFFSET)
#define SW_API_VLAN_TRANS_DSCP_PCP_MAPPING_GET	(85 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_ACT_CTRL_SET	(86 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_ACT_CTRL_GET	(87 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_ACT_SET	(88 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_ACT_GET	(89 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_MEM_SET  (90 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_ISOL_MEM_GET  (91 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PVLAN_RX_CFG_SET	(92 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PVLAN_RX_CFG_GET	(93 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PVLAN_MAP_SET	(94 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PVLAN_MAP_GET	(95 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PVLAN_TX_CFG_SET (96 + SW_API_PORTVLAN_OFFSET)
#define SW_API_PVLAN_TX_CFG_GET (97 + SW_API_PORTVLAN_OFFSET)
...
#define SW_API_ACL_RULE_PRIORITY_SET		(31  + SW_API_ACL_OFFSET)
#define SW_API_ACL_RULE_PRIORITY_GET            (32  + SW_API_ACL_OFFSET)
#define SW_API_ACL_DSCP_PCP_MAPPING_SET		(33  + SW_API_ACL_OFFSET)
#define SW_API_ACL_DSCP_PCP_MAPPING_GET		(34  + SW_API_ACL_OFFSET)
...
/* remove Hawkeye specific feature */
...
#define SW_API_QOS_PORT_PCP_CFG_GET (53  + SW_API_QOS_OFFSET)
#define SW_API_QOS_PORT_PCP_CFG_SET (54  + SW_API_QOS_OFFSET)
...
#define SW_API_IP_PORT_VLAN_AS_FLOW_KEY_GET	(84 + SW_API_IP_OFFSET)
#define SW_API_IP_PORT_VLAN_AS_FLOW_KEY_SET	(85 + SW_API_IP_OFFSET)
#define SW_API_IP_INTF_VLAN_AS_FLOW_KEY_GET	(86 + SW_API_IP_OFFSET)
#define SW_API_IP_INTF_VLAN_AS_FLOW_KEY_SET	(87 + SW_API_IP_OFFSET)
...
#define SW_API_QM_COUNTER_MONITOR_EN_SET		(35 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_EN_GET		(36 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_STATS_CLEANUP		(37 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_STATUS_GET		(38 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_MAP_SET		(39 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_MAP_GET		(40 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_CTRL_SET		(41 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_CTRL_GET		(42 + SW_API_QM_OFFSET)
#define SW_API_QM_COUNTER_MONITOR_STATS_GET		(43 + SW_API_QM_OFFSET)
#define SW_API_QM_TCONT_GET			(44 + SW_API_QM_OFFSET)
#define SW_API_QM_TCONT_SET			(45 + SW_API_QM_OFFSET)
#define SW_API_QM_CPUCODE_ENQUEUE_GET		(46 + SW_API_QM_OFFSET)
#define SW_API_QM_CPUCODE_ENQUEUE_SET		(47 + SW_API_QM_OFFSET)
#define SW_API_QM_TCONT_STAT_GET		(48 + SW_API_QM_OFFSET)
#define SW_API_UCAST_QUEUE_DDRQ_EN_SET		(49 + SW_API_QM_OFFSET)
#define SW_API_UCAST_QUEUE_DDRQ_EN_GET		(50 + SW_API_QM_OFFSET)
#define SW_API_QM_TCONT_STAT_SET		(51 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET	(52 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET	(53 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET	(54 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET	(55 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_CPUCODE_SET		(56 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_CPUCODE_GET		(57 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET		(58 + SW_API_QM_OFFSET)
#define SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET		(59 + SW_API_QM_OFFSET)
#define SW_API_QM_DEQUEUE_DROP_SET			(60 + SW_API_QM_OFFSET)
#define SW_API_QM_DEQUEUE_DROP_GET			(61 + SW_API_QM_OFFSET)
#define SW_API_QM_CROSSCHIP_BP_QMAP_SET			(62 + SW_API_QM_OFFSET)
#define SW_API_QM_CROSSCHIP_BP_QMAP_GET			(63 + SW_API_QM_OFFSET)
#define SW_API_QM_CROSSCHIP_BP_STATUS_GET		(64 + SW_API_QM_OFFSET)
#define SW_API_AC_DROP_STATE_SET			(65 + SW_API_QM_OFFSET)
#define SW_API_AC_DROP_STATE_GET			(66 + SW_API_QM_OFFSET)
#define SW_API_QM_MCAST_ENQUEUE_CTRL_SET		(67 + SW_API_QM_OFFSET)
#define SW_API_QM_MCAST_ENQUEUE_CTRL_GET		(68 + SW_API_QM_OFFSET)
...
#define SW_API_FLOW_KEY_GET		(38  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_KEY_SET		(39  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_SAMPLING_ID_GET	(40  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_SAMPLING_ID_SET	(41  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_GRO_EN_GET		(42  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_GRO_EN_SET		(43  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_EIP_LOOKUP_MODE_GET	(44  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_EIP_LOOKUP_MODE_SET	(45  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_FWD_TYPE_SET	(46  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_FWD_TYPE_GET	(47  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_APP_ADD		(48  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_APP_GET		(49  + SW_API_FLOW_OFFSET)
#define SW_API_FLOW_APP_DEL		(50  + SW_API_FLOW_OFFSET)
...
#define SW_API_TUNNEL_TUPLE_ENTRY_ADD		(46 + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_TUPLE_ENTRY_DEL		(47 + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_TUPLE_ENTRY_GETFIRST	(48 + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_TUPLE_ENTRY_GETNEXT	(49 + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_DECAP_MISS_ACTION_SET	(50 + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_DECAP_MISS_ACTION_GET	(51 + SW_API_TUNNEL_OFFSET)
...
#define SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET	(8 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET	(9 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET	(10 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET	(11 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET	(12 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET	(13 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET	(14 + SW_API_ATHTAG_OFFSET)
#define SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET	(15 + SW_API_ATHTAG_OFFSET)
...
#define SW_API_PKTEDIT_EN_SET			(2 + SW_API_PKTEDIT_OFFSET)
...
/* pon */
#define SW_API_PON_OFFSET			4200
#define SW_API_PON_GEMPORT_GLB_SET			(0 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GLB_GET			(1 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GEN_DFT_SET		(2 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GEN_DFT_GET		(3 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GEN_ENTRY_SET	(4 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GEN_ENTRY_GET	(5 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GEN_EN_SET		(6 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_GEN_EN_GET		(7 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_MAP_EN_SET		(8 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_MAP_EN_GET		(9 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_MAP_SET			(10 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_MAP_GET			(11 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_CFG_SET			(12 + SW_API_PON_OFFSET)
#define SW_API_PON_GEMPORT_CFG_GET			(13 + SW_API_PON_OFFSET)
...
/* IPMC */
#define SW_API_IPMC_OFFSET			4400
#define SW_API_IPMC_STATUS_SET			(0 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_STATUS_GET			(1 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_GLOBAL_CFG_SET		(2 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_GLOBAL_CFG_GET		(3 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_ENTRY_ADD			(4 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_ENTRY_DEL			(5 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_ENTRY_GET			(6 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_ENTRY_GETNEXT		(7 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_ENTRY_FLUSH			(8 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_UCAST_FWD_SET		(9 + SW_API_IPMC_OFFSET)
#define SW_API_IPMC_UCAST_FWD_GET		(10 + SW_API_IPMC_OFFSET)

/* CROSSCHIP */
#define SW_API_CROSSCHIP_OFFSET			4500
#define SW_API_CROSSCHIP_BP_MODE_SET	(0 + SW_API_CROSSCHIP_OFFSET)
#define SW_API_CROSSCHIP_BP_MODE_GET	(1 + SW_API_CROSSCHIP_OFFSET)
#define SW_API_CROSSCHIP_BP_EN_SET		(2 + SW_API_CROSSCHIP_OFFSET)
#define SW_API_CROSSCHIP_BP_EN_GET		(3 + SW_API_CROSSCHIP_OFFSET)
