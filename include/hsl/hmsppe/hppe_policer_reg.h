...
#define IN_PORT_METER_CFG_TBL_NUM     9
...
#define IN_PORT_METER_CRDT_TBL_NUM     9
...
#define IN_PORT_METER_CNT_TBL_NUM     27
...
#define PORT_TX_DROP_CNT_TBL_NUM     9
