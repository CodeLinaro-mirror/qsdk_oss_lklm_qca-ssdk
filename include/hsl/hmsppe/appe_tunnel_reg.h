...
#ifndef _APPE_TUNNEL_REG_H_
#define _APPE_TUNNEL_REG_H_

/*[register] TPR_UDF_CTRL_0*/
#define TPR_UDF_CTRL_0
#define TPR_UDF_CTRL_0_ADDRESS 0x440
...
#define TPR_UDF_CTRL_0_DEFAULT 0x0
	...
	#define TPR_UDF_CTRL_0_UDF_PROFILE_OFFSET  19
...
#define TPR_UDF_PROFILE_OFFSET_ADDRESS 0x4a0
...
#define EG_IPV4_HDR_CTRL_ADDRESS 0x90
...
#define EG_UDP_ENTROPY_CTRL_ADDRESS 0x94
...
#define ECN_PROFILE
#define ECN_PROFILE_ADDRESS 0xa0
...
#define EG_PROTO_MAPPING0_ADDRESS 0xa8
...
#define EG_PROTO_MAPPING1_ADDRESS 0xb0
...
#define EG_XLAT_TUN_CTRL_DEFAULT 0x0
	...
	#define EG_XLAT_TUN_CTRL_IPV4_DF_MODE_EXT
	#define EG_XLAT_TUN_CTRL_IPV4_DF_MODE_EXT_OFFSET  3
	#define EG_XLAT_TUN_CTRL_IPV4_DF_MODE_EXT_LEN     1
	#define EG_XLAT_TUN_CTRL_IPV4_DF_MODE_EXT_DEFAULT 0x0
	/*[field] EDIT_RULE_ID*/
	...
	/*[field] STCI*/
	#define EG_XLAT_TUN_CTRL_STCI
	#define EG_XLAT_TUN_CTRL_STCI_OFFSET  77
	#define EG_XLAT_TUN_CTRL_STCI_LEN     16
	#define EG_XLAT_TUN_CTRL_STCI_DEFAULT 0x0
	/*[field] CTCI*/
	#define EG_XLAT_TUN_CTRL_CTCI
	#define EG_XLAT_TUN_CTRL_CTCI_OFFSET  93
	#define EG_XLAT_TUN_CTRL_CTCI_LEN     16
	#define EG_XLAT_TUN_CTRL_CTCI_DEFAULT 0x0
	/*[field] STAG_TPID*/
	#define EG_XLAT_TUN_CTRL_STAG_TPID
	#define EG_XLAT_TUN_CTRL_STAG_TPID_OFFSET  109
	#define EG_XLAT_TUN_CTRL_STAG_TPID_LEN     2
	#define EG_XLAT_TUN_CTRL_STAG_TPID_DEFAULT 0x0
	/*[field] CTAG_TPID*/
	#define EG_XLAT_TUN_CTRL_CTAG_TPID
	#define EG_XLAT_TUN_CTRL_CTAG_TPID_OFFSET  111
	#define EG_XLAT_TUN_CTRL_CTAG_TPID_LEN     2
	#define EG_XLAT_TUN_CTRL_CTAG_TPID_DEFAULT 0x0
...
struct eg_xlat_tun_ctrl {
	...
	a_uint32_t  stci:16;
	a_uint32_t  ctci_0:3;
	a_uint32_t  ctci_1:13;
	a_uint32_t  stag_tpid:2;
	a_uint32_t  ctag_tpid:2;
...
#define TL_VLAN_TBL_DEFAULT 0x0
	...
	#define TL_VLAN_TBL_TL_L3_IF_VALID_OFFSET  44
...
#define TL_KEY_GEN_DEFAULT 0x0
	...
	#define TL_KEY_GEN_KEY_TYPE_LEN     5
	#define TL_KEY_GEN_KEY_TYPE_DEFAULT 0x0
	/*[field] DECAP_EN*/
	#define TL_KEY_GEN_DECAP_EN
	#define TL_KEY_GEN_DECAP_EN_OFFSET  81
	#define TL_KEY_GEN_DECAP_EN_LEN     1
	#define TL_KEY_GEN_DECAP_EN_DEFAULT 0x0
	/*[field] SERVICE_CODE_EN*/
	#define TL_KEY_GEN_SERVICE_CODE_EN
	#define TL_KEY_GEN_SERVICE_CODE_EN_OFFSET  82
	#define TL_KEY_GEN_SERVICE_CODE_EN_LEN     1
	#define TL_KEY_GEN_SERVICE_CODE_EN_DEFAULT 0x0
	/*[field] SERVICE_CODE*/
	#define TL_KEY_GEN_SERVICE_CODE
	#define TL_KEY_GEN_SERVICE_CODE_OFFSET  83
	#define TL_KEY_GEN_SERVICE_CODE_LEN     8
	#define TL_KEY_GEN_SERVICE_CODE_DEFAULT 0x0
	/*[field] VNI_UDF_EN*/
	#define TL_KEY_GEN_VNI_UDF_EN
	#define TL_KEY_GEN_VNI_UDF_EN_OFFSET  91
	#define TL_KEY_GEN_VNI_UDF_EN_LEN     1
	#define TL_KEY_GEN_VNI_UDF_EN_DEFAULT 0x0
	/*[field] VNI_UDF0_INC*/
	#define TL_KEY_GEN_VNI_UDF0_INC
	#define TL_KEY_GEN_VNI_UDF0_INC_OFFSET  92
	#define TL_KEY_GEN_VNI_UDF0_INC_LEN     1
	#define TL_KEY_GEN_VNI_UDF0_INC_DEFAULT 0x0
	/*[field] VNI_UDF0_ID*/
	#define TL_KEY_GEN_VNI_UDF0_ID
	#define TL_KEY_GEN_VNI_UDF0_ID_OFFSET  93
	#define TL_KEY_GEN_VNI_UDF0_ID_LEN     2
	#define TL_KEY_GEN_VNI_UDF0_ID_DEFAULT 0x0
	/*[field] VNI_UDF1_INC*/
	#define TL_KEY_GEN_VNI_UDF1_INC
	#define TL_KEY_GEN_VNI_UDF1_INC_OFFSET  95
	#define TL_KEY_GEN_VNI_UDF1_INC_LEN     1
	#define TL_KEY_GEN_VNI_UDF1_INC_DEFAULT 0x0
	/*[field] VNI_UDF1_ID*/
	#define TL_KEY_GEN_VNI_UDF1_ID
	#define TL_KEY_GEN_VNI_UDF1_ID_OFFSET  96
	#define TL_KEY_GEN_VNI_UDF1_ID_LEN     2
	#define TL_KEY_GEN_VNI_UDF1_ID_DEFAULT 0x0
	/*[field] LPM_PREFIX_LEN_EN*/
	#define TL_KEY_GEN_LPM_PREFIX_LEN_EN
	#define TL_KEY_GEN_LPM_PREFIX_LEN_EN_OFFSET  98
	#define TL_KEY_GEN_LPM_PREFIX_LEN_EN_LEN     1
	#define TL_KEY_GEN_LPM_PREFIX_LEN_EN_DEFAULT 0x0
...
struct tl_key_gen {
	...
	a_uint32_t  key_type:5;
	a_uint32_t  decap_en:1;
	a_uint32_t  service_code_en:1;
	a_uint32_t  service_code:8;
	a_uint32_t  vni_udf_en:1;
	a_uint32_t  vni_udf0_inc:1;
	a_uint32_t  vni_udf0_id:2;
	a_uint32_t  vni_udf1_inc:1;
	a_uint32_t  vni_udf1_id:2;
	a_uint32_t  lpm_prefix_len_en:1;
...
#define TL_TBL_DEFAULT 0x0
	...
	#define TL_TBL_CVLAN_CHECK_EN_OFFSET  436
	...
	#define TL_TBL_TL_L3_IF_CHECK_EN_OFFSET  437
	#define TL_TBL_TL_L3_IF_CHECK_EN_LEN     1
	#define TL_TBL_TL_L3_IF_CHECK_EN_DEFAULT 0x0
	/*[field] EXP_PROFILE*/
	#define TL_TBL_EXP_PROFILE
	#define TL_TBL_EXP_PROFILE_OFFSET  438
	#define TL_TBL_EXP_PROFILE_LEN     2
	#define TL_TBL_EXP_PROFILE_DEFAULT 0x0
	/*[field] INNER_TYPE_EN*/
	#define TL_TBL_INNER_TYPE_EN
	#define TL_TBL_INNER_TYPE_EN_OFFSET  440
	#define TL_TBL_INNER_TYPE_EN_LEN     1
	#define TL_TBL_INNER_TYPE_EN_DEFAULT 0x0
	/*[field] INNER_TYPE*/
	#define TL_TBL_INNER_TYPE
	#define TL_TBL_INNER_TYPE_OFFSET  441
	#define TL_TBL_INNER_TYPE_LEN     2
	#define TL_TBL_INNER_TYPE_DEFAULT 0x0
	/*[field] INNER_OFFSET_EN*/
	#define TL_TBL_INNER_OFFSET_EN
	#define TL_TBL_INNER_OFFSET_EN_OFFSET  443
	#define TL_TBL_INNER_OFFSET_EN_LEN     1
	#define TL_TBL_INNER_OFFSET_EN_DEFAULT 0x0
	/*[field] INNER_OFFSET_MODE*/
	#define TL_TBL_INNER_OFFSET_MODE
	#define TL_TBL_INNER_OFFSET_MODE_OFFSET  444
	#define TL_TBL_INNER_OFFSET_MODE_LEN     1
	#define TL_TBL_INNER_OFFSET_MODE_DEFAULT 0x0
	/*[field] INNER_OFFSET*/
	#define TL_TBL_INNER_OFFSET
	#define TL_TBL_INNER_OFFSET_OFFSET  445
	#define TL_TBL_INNER_OFFSET_LEN     5
	#define TL_TBL_INNER_OFFSET_DEFAULT 0x0
...
struct tl_tbl_0 {
	...
	a_uint32_t  ipv4_src_addr_0:17;
	a_uint32_t  ipv4_src_addr_1:15;
	a_uint32_t  ipv4_dst_addr_0:17;
	a_uint32_t  ipv4_dst_addr_1:15;
	a_uint32_t  _reserved0_0:17;
	...
	a_uint32_t  _reserved0_6:15;
	a_uint32_t  l4_sport:16;
	a_uint32_t  l4_dport_0:1;
	a_uint32_t  l4_dport_1:15;
	a_uint32_t  vni_resv_0:17;
	a_uint32_t  vni_resv_1:15;
	a_uint32_t  udf0:16;
	a_uint32_t  udf1_0:1;
	a_uint32_t  udf1_1:15;
	...
	a_uint32_t  svlan_id_0:6;
	a_uint32_t  svlan_id_1:6;
	...
	a_uint32_t  inner_type_en:1;
	a_uint32_t  inner_type:2;
	a_uint32_t  inner_offset_en:1;
	a_uint32_t  inner_offset_mode:1;
	a_uint32_t  inner_offset_0:3;
	a_uint32_t  inner_offset_1:2;
