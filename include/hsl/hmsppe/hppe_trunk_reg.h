...
#ifndef _HPPE_TRUNK_REG_H_
#define _HPPE_TRUNK_REG_H_
...
#define TRUNK_FILTER_DEFAULT 0x0
	...
	#define TRUNK_FILTER_MEM_BITMAP_LEN     9
	#define TRUNK_FILTER_MEM_BITMAP_DEFAULT 0x0

struct trunk_filter {
	a_uint32_t  mem_bitmap:9;
...
#define TRUNK_MEMBER_DEFAULT 0x0
	...
	#define TRUNK_MEMBER_MEMBER_0_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_1_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_2_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_3_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_4_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_5_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_6_PORT_ID_LEN     4
	...
	#define TRUNK_MEMBER_MEMBER_7_PORT_ID_LEN     4
	#define TRUNK_MEMBER_MEMBER_7_PORT_ID_DEFAULT 0x0

struct trunk_member {
	a_uint32_t  member_0_port_id:4;
	a_uint32_t  member_1_port_id:4;
	a_uint32_t  member_2_port_id:4;
	a_uint32_t  member_3_port_id:4;
	a_uint32_t  member_4_port_id:4;
	a_uint32_t  member_5_port_id:4;
	a_uint32_t  member_6_port_id:4;
	a_uint32_t  member_7_port_id:4;
};
