...
#define L3_ROUTE_CTRL_EXT_DEFAULT 0x31b23
	...
	/*[field] ROUTING_AS_FLOW_KEY*/
	#define L3_ROUTE_CTRL_EXT_ROUTING_AS_FLOW_KEY
	#define L3_ROUTE_CTRL_EXT_ROUTING_AS_FLOW_KEY_OFFSET  18
	#define L3_ROUTE_CTRL_EXT_ROUTING_AS_FLOW_KEY_LEN     1
	#define L3_ROUTE_CTRL_EXT_ROUTING_AS_FLOW_KEY_DEFAULT 0x0
	/*[field] IPSEC_AH_EN*/
	#define L3_ROUTE_CTRL_EXT_IPSEC_AH_EN
	#define L3_ROUTE_CTRL_EXT_IPSEC_AH_EN_OFFSET  19
	#define L3_ROUTE_CTRL_EXT_IPSEC_AH_EN_LEN     1
	#define L3_ROUTE_CTRL_EXT_IPSEC_AH_EN_DEFAULT 0x0
	/*[field] IPSEC_ESP_EN*/
	#define L3_ROUTE_CTRL_EXT_IPSEC_ESP_EN
	#define L3_ROUTE_CTRL_EXT_IPSEC_ESP_EN_OFFSET  20
	#define L3_ROUTE_CTRL_EXT_IPSEC_ESP_EN_LEN     1
	#define L3_ROUTE_CTRL_EXT_IPSEC_ESP_EN_DEFAULT 0x0
	/*[field] IPSEC_NATT_EN*/
	#define L3_ROUTE_CTRL_EXT_IPSEC_NATT_EN
	#define L3_ROUTE_CTRL_EXT_IPSEC_NATT_EN_OFFSET  21
	#define L3_ROUTE_CTRL_EXT_IPSEC_NATT_EN_LEN     1
	#define L3_ROUTE_CTRL_EXT_IPSEC_NATT_EN_DEFAULT 0x0
...
struct l3_route_ctrl_ext {
	...
	a_uint32_t  routing_as_flow_key:1;
	a_uint32_t  ipsec_ah_en:1;
	a_uint32_t  ipsec_esp_en:1;
	a_uint32_t  ipsec_natt_en:1;
...
#define HOST_TBL_OP
#define HOST_TBL_OP_ADDRESS 0x730
...
#define HOST_TBL_OP_RSLT_ADDRESS 0x77c
...
#define HOST_TBL_RD_OP_ADDRESS 0x790
...
#define HOST_TBL_RD_OP_RSLT_ADDRESS 0x7dc
...
#define L3_VSI_DEFAULT 0x0
	...
	/*[field] IPV4_SG_PASS_CMD*/
	#define L3_VSI_IPV4_SG_PASS_CMD
	#define L3_VSI_IPV4_SG_PASS_CMD_OFFSET  13
	#define L3_VSI_IPV4_SG_PASS_CMD_LEN     2
	#define L3_VSI_IPV4_SG_PASS_CMD_DEFAULT 0x0
	/*[field] IPV6_SG_PASS_CMD*/
	#define L3_VSI_IPV6_SG_PASS_CMD
	#define L3_VSI_IPV6_SG_PASS_CMD_OFFSET  15
	#define L3_VSI_IPV6_SG_PASS_CMD_LEN     2
	#define L3_VSI_IPV6_SG_PASS_CMD_DEFAULT 0x0
	/*[field] IP_ARP_SG_PASS_CMD*/
	#define L3_VSI_IP_ARP_SG_PASS_CMD
	#define L3_VSI_IP_ARP_SG_PASS_CMD_OFFSET  17
	#define L3_VSI_IP_ARP_SG_PASS_CMD_LEN     2
	#define L3_VSI_IP_ARP_SG_PASS_CMD_DEFAULT 0x0
	/*[field] IP_ND_SG_PASS_CMD*/
	#define L3_VSI_IP_ND_SG_PASS_CMD
	#define L3_VSI_IP_ND_SG_PASS_CMD_OFFSET  19
	#define L3_VSI_IP_ND_SG_PASS_CMD_LEN     2
	#define L3_VSI_IP_ND_SG_PASS_CMD_DEFAULT 0x0
...
struct l3_vsi {
	...
	a_uint32_t  ipv4_sg_pass_cmd:2;
	a_uint32_t  ipv6_sg_pass_cmd:2;
	a_uint32_t  ip_arp_sg_pass_cmd:2;
	a_uint32_t  ip_nd_sg_pass_cmd:2;
...
/*[register] L3_VSI_EXT*/
#define L3_VSI_EXT
#define L3_VSI_EXT_ADDRESS 0x1354
...
#define L3_VP_PORT_TBL_DEFAULT 0x0
	...
	/*[field] VLAN_AS_FLOW_KEY*/
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_OFFSET  105
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_LEN     1
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_DEFAULT 0x0
	/*[field] VLAN_AS_FLOW_KEY_MODE*/
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_MODE
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_MODE_OFFSET  106
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_MODE_LEN     2
	#define L3_VP_PORT_TBL_VLAN_AS_FLOW_KEY_MODE_DEFAULT 0x0
	/*[field] IPV4_SG_PASS_CMD*/
	#define L3_VP_PORT_TBL_IPV4_SG_PASS_CMD
	#define L3_VP_PORT_TBL_IPV4_SG_PASS_CMD_OFFSET  108
	#define L3_VP_PORT_TBL_IPV4_SG_PASS_CMD_LEN     2
	#define L3_VP_PORT_TBL_IPV4_SG_PASS_CMD_DEFAULT 0x0
	/*[field] IPV6_SG_PASS_CMD*/
	#define L3_VP_PORT_TBL_IPV6_SG_PASS_CMD
	#define L3_VP_PORT_TBL_IPV6_SG_PASS_CMD_OFFSET  110
	#define L3_VP_PORT_TBL_IPV6_SG_PASS_CMD_LEN     2
	#define L3_VP_PORT_TBL_IPV6_SG_PASS_CMD_DEFAULT 0x0
	/*[field] IP_ARP_SG_PASS_CMD*/
	#define L3_VP_PORT_TBL_IP_ARP_SG_PASS_CMD
	#define L3_VP_PORT_TBL_IP_ARP_SG_PASS_CMD_OFFSET  112
	#define L3_VP_PORT_TBL_IP_ARP_SG_PASS_CMD_LEN     2
	#define L3_VP_PORT_TBL_IP_ARP_SG_PASS_CMD_DEFAULT 0x0
	/*[field] IP_ND_SG_PASS_CMD*/
	#define L3_VP_PORT_TBL_IP_ND_SG_PASS_CMD
	#define L3_VP_PORT_TBL_IP_ND_SG_PASS_CMD_OFFSET  114
	#define L3_VP_PORT_TBL_IP_ND_SG_PASS_CMD_LEN     2
	#define L3_VP_PORT_TBL_IP_ND_SG_PASS_CMD_DEFAULT 0x0
...
struct l3_vp_port_tbl {
	...
	a_uint32_t  vlan_as_flow_key:1;
	a_uint32_t  vlan_as_flow_key_mode:2;
	a_uint32_t  ipv4_sg_pass_cmd:2;
	a_uint32_t  ipv6_sg_pass_cmd:2;
	a_uint32_t  ip_arp_sg_pass_cmd:2;
	a_uint32_t  ip_nd_sg_pass_cmd:2;
...
#define IN_L3_IF_TBL_DEFAULT 0x0
	...
	/*[field] VLAN_AS_FLOW_KEY_L3IF*/
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_L3IF
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_L3IF_OFFSET  129
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_L3IF_LEN     1
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_L3IF_DEFAULT 0x0
	/*[field] VLAN_AS_FLOW_KEY_MODE*/
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_MODE
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_MODE_OFFSET  130
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_MODE_LEN     2
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_MODE_DEFAULT 0x0
	/*[field] VLAN_AS_FLOW_KEY_PORT*/
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_PORT
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_PORT_OFFSET  132
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_PORT_LEN     1
	#define IN_L3_IF_TBL_VLAN_AS_FLOW_KEY_PORT_DEFAULT 0x0
	/*[field] L3_DST_VALID*/
	#define IN_L3_IF_TBL_L3_DST_VALID
	#define IN_L3_IF_TBL_L3_DST_VALID_OFFSET  133
	#define IN_L3_IF_TBL_L3_DST_VALID_LEN     1
	#define IN_L3_IF_TBL_L3_DST_VALID_DEFAULT 0x0
	/*[field] L3_DST_CMD*/
	#define IN_L3_IF_TBL_L3_DST_CMD
	#define IN_L3_IF_TBL_L3_DST_CMD_OFFSET  134
	#define IN_L3_IF_TBL_L3_DST_CMD_LEN     2
	#define IN_L3_IF_TBL_L3_DST_CMD_DEFAULT 0x0
	/*[field] L3_DST_PORT*/
	#define IN_L3_IF_TBL_L3_DST_PORT
	#define IN_L3_IF_TBL_L3_DST_PORT_OFFSET  136
	#define IN_L3_IF_TBL_L3_DST_PORT_LEN     8
	#define IN_L3_IF_TBL_L3_DST_PORT_DEFAULT 0x0
	/*[field] IPV4_MC_ROUTE_EN*/
	#define IN_L3_IF_TBL_IPV4_MC_ROUTE_EN
	#define IN_L3_IF_TBL_IPV4_MC_ROUTE_EN_OFFSET  144
	#define IN_L3_IF_TBL_IPV4_MC_ROUTE_EN_LEN     1
	#define IN_L3_IF_TBL_IPV4_MC_ROUTE_EN_DEFAULT 0x0
	/*[field] IPV6_MC_ROUTE_EN*/
	#define IN_L3_IF_TBL_IPV6_MC_ROUTE_EN
	#define IN_L3_IF_TBL_IPV6_MC_ROUTE_EN_OFFSET  145
	#define IN_L3_IF_TBL_IPV6_MC_ROUTE_EN_LEN     1
	#define IN_L3_IF_TBL_IPV6_MC_ROUTE_EN_DEFAULT 0x0
	/*[field] L3_IPV4_MC_MODE*/
	#define IN_L3_IF_TBL_L3_IPV4_MC_MODE
	#define IN_L3_IF_TBL_L3_IPV4_MC_MODE_OFFSET  146
	#define IN_L3_IF_TBL_L3_IPV4_MC_MODE_LEN     1
	#define IN_L3_IF_TBL_L3_IPV4_MC_MODE_DEFAULT 0x0
	/*[field] L3_IPV6_MC_MODE*/
	#define IN_L3_IF_TBL_L3_IPV6_MC_MODE
	#define IN_L3_IF_TBL_L3_IPV6_MC_MODE_OFFSET  147
	#define IN_L3_IF_TBL_L3_IPV6_MC_MODE_LEN     1
	#define IN_L3_IF_TBL_L3_IPV6_MC_MODE_DEFAULT 0x0
...
struct in_l3_if_tbl {
	...
	a_uint32_t  mac_da_1:32;
	a_uint32_t  mac_valid:1;
	a_uint32_t  vlan_as_flow_key_l3if:1;
	a_uint32_t  vlan_as_flow_key_mode:2;
	a_uint32_t  vlan_as_flow_key_port:1;
	a_uint32_t  l3_dst_valid:1;
	a_uint32_t  l3_dst_cmd:2;
	a_uint32_t  l3_dst_port:8;
	a_uint32_t  ipv4_mc_route_en:1;
	a_uint32_t  ipv6_mc_route_en:1;
	a_uint32_t  l3_ipv4_mc_mode:1;
	a_uint32_t  l3_ipv6_mc_mode:1;
	a_uint32_t  _reserved0:12;
};
