...
#ifndef _HPPE_RSS_REG_H_
#define _HPPE_RSS_REG_H_
...
#define RSS_HASH_MASK_REG_DEFAULT 0x0
	...
	/*[field] RSS_HASH_FRAGMENT*/
	#define RSS_HASH_MASK_REG_RSS_HASH_FRAGMENT
	#define RSS_HASH_MASK_REG_RSS_HASH_FRAGMENT_OFFSET  28
	#define RSS_HASH_MASK_REG_RSS_HASH_FRAGMENT_LEN     1
	#define RSS_HASH_MASK_REG_RSS_HASH_FRAGMENT_DEFAULT 0x0
...
#define RSS_HASH_MASK_IPV4_REG_DEFAULT 0x0
	...
	/*[field] RSS_HASH_FRAGMENT*/
	#define RSS_HASH_MASK_IPV4_REG_RSS_HASH_FRAGMENT
	#define RSS_HASH_MASK_IPV4_REG_RSS_HASH_FRAGMENT_OFFSET  28
	#define RSS_HASH_MASK_IPV4_REG_RSS_HASH_FRAGMENT_LEN     1
	#define RSS_HASH_MASK_IPV4_REG_RSS_HASH_FRAGMENT_DEFAULT 0x0
