...
#ifndef _APPE_COUNTER_REG_H_
#define _APPE_COUNTER_REG_H_

/*[register] PORT_VP_RX_CNT_MODE*/
...
struct port_vp_rx_cnt_mode {
	a_uint32_t  cnt_mode:32;
};

union port_vp_rx_cnt_mode_tbl_u {
	a_uint32_t val;
	struct port_vp_rx_cnt_mode bf;
};
...
#define PHY_PORT_RX_CNT_TBL_NUM     9
