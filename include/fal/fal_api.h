...
#define PORTVLAN_API \
    ...
    SW_API_DEF(SW_API_PVLAN_RX_CFG_SET, fal_private_vlan_rx_cfg_set), \
    SW_API_DEF(SW_API_PVLAN_RX_CFG_GET, fal_private_vlan_rx_cfg_get), \
    SW_API_DEF(SW_API_PVLAN_MAP_SET, fal_private_vlan_mapping_set), \
    SW_API_DEF(SW_API_PVLAN_MAP_GET, fal_private_vlan_mapping_get), \
    SW_API_DEF(SW_API_PVLAN_TX_CFG_SET, fal_private_vlan_tx_cfg_set), \
    SW_API_DEF(SW_API_PVLAN_TX_CFG_GET, fal_private_vlan_tx_cfg_get),
...
#define PORTVLAN_API_PARAM \
    ...
    SW_API_DESC(SW_API_PVLAN_RX_CFG_SET) \
    SW_API_DESC(SW_API_PVLAN_RX_CFG_GET) \
    SW_API_DESC(SW_API_PVLAN_MAP_SET) \
    SW_API_DESC(SW_API_PVLAN_MAP_GET) \
    SW_API_DESC(SW_API_PVLAN_TX_CFG_SET) \
    SW_API_DESC(SW_API_PVLAN_TX_CFG_GET)
#else
#define PORTVLAN_API \
    SW_API_DEF(SW_API_GLOBAL_QINQ_MODE_SET, fal_global_qinq_mode_set), \
    SW_API_DEF(SW_API_GLOBAL_QINQ_MODE_GET, fal_global_qinq_mode_get), \
...
#define FLOW_API \
    ...
    SW_API_DEF(SW_API_FLOW_KEY_GET, fal_flow_key_get), \
    SW_API_DEF(SW_API_FLOW_KEY_SET, fal_flow_key_set), \
...
#define FLOW_API_PARAM \
    ...
    SW_API_DESC(SW_API_FLOW_KEY_GET) \
    SW_API_DESC(SW_API_FLOW_KEY_SET) \
...
#define QM_API \
    ...
    SW_API_DEF(SW_API_QM_TCONT_STAT_SET, fal_qm_tcont_stat_set), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET, fal_qm_passthrough_source_profile_set), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET, fal_qm_passthrough_source_profile_get), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET, fal_qm_passthrough_direct_enqueue_set), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET, fal_qm_passthrough_direct_enqueue_get), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_SET, fal_qm_passthrough_cpucode_set), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_GET, fal_qm_passthrough_cpucode_get), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET, fal_qm_passthrough_cpucode_en_set), \
    SW_API_DEF(SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET, fal_qm_passthrough_cpucode_en_get), \
    SW_API_DEF(SW_API_QM_DEQUEUE_DROP_SET, fal_qm_dequeue_drop_set), \
...
#define QM_API_PARAM \
    ...
    SW_API_DESC(SW_API_QM_TCONT_STAT_SET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_SET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_SOURCE_PROFILE_GET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_SET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_DIRECT_ENQUEUE_GET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_CPUCODE_SET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_CPUCODE_GET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_CPUCODE_EN_SET) \
    SW_API_DESC(SW_API_QM_PASSTHROUGH_CPUCODE_EN_GET) \
    SW_API_DESC(SW_API_QM_DEQUEUE_DROP_SET) \
...
#define TUNNEL_API \
	...
	SW_API_DEF(SW_API_TUNNEL_TUPLE_ENTRY_ADD, fal_tunnel_tuple_entry_add), \
	SW_API_DEF(SW_API_TUNNEL_TUPLE_ENTRY_DEL, fal_tunnel_tuple_entry_del), \
	SW_API_DEF(SW_API_TUNNEL_TUPLE_ENTRY_GETFIRST, fal_tunnel_tuple_entry_getfirst), \
	SW_API_DEF(SW_API_TUNNEL_TUPLE_ENTRY_GETNEXT, fal_tunnel_tuple_entry_getnext), \
	SW_API_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_SET, fal_tunnel_decap_miss_action_set), \
	SW_API_DEF(SW_API_TUNNEL_DECAP_MISS_ACTION_GET, fal_tunnel_decap_miss_action_get),
#define TUNNEL_API_PARAM \
	...
	SW_API_DESC(SW_API_TUNNEL_TUPLE_ENTRY_ADD) \
	SW_API_DESC(SW_API_TUNNEL_TUPLE_ENTRY_DEL) \
	SW_API_DESC(SW_API_TUNNEL_TUPLE_ENTRY_GETFIRST) \
	SW_API_DESC(SW_API_TUNNEL_TUPLE_ENTRY_GETNEXT) \
	SW_API_DESC(SW_API_TUNNEL_DECAP_MISS_ACTION_SET) \
	SW_API_DESC(SW_API_TUNNEL_DECAP_MISS_ACTION_GET)
#else
#define TUNNEL_API \
	SW_API_DEF(SW_API_TUNNEL_INTF_SET, fal_tunnel_intf_set), \
	SW_API_DEF(SW_API_TUNNEL_INTF_GET, fal_tunnel_intf_get), \
...
#define ATHTAG_API \
	...
	SW_API_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET, fal_athtag_rx_src_port_mapping_set), \
	SW_API_DEF(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET, fal_athtag_rx_src_port_mapping_get), \
	SW_API_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET, fal_athtag_rx_dest_port_mapping_set), \
	SW_API_DEF(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET, fal_athtag_rx_dest_port_mapping_get), \
	SW_API_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET, fal_athtag_rx_servcode_mapping_set), \
	SW_API_DEF(SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET, fal_athtag_rx_servcode_mapping_get), \
	SW_API_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET, fal_athtag_tx_src_port_mapping_set), \
	SW_API_DEF(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET, fal_athtag_tx_src_port_mapping_get),
#define ATHTAG_API_PARAM \
	...
	SW_API_DESC(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_SET) \
	SW_API_DESC(SW_API_ATHTAG_RX_SRC_PORT_MAPPING_GET) \
	SW_API_DESC(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_SET) \
	SW_API_DESC(SW_API_ATHTAG_RX_DEST_PORT_MAPPING_GET) \
	SW_API_DESC(SW_API_ATHTAG_RX_SERVCODE_MAPPING_SET) \
	SW_API_DESC(SW_API_ATHTAG_RX_SERVCODE_MAPPING_GET) \
	SW_API_DESC(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_SET) \
	SW_API_DESC(SW_API_ATHTAG_TX_SRC_PORT_MAPPING_GET)
#else
#define ATHTAG_API
#define ATHTAG_API_PARAM
#endif
...
#define QOS_LEGACY_API_PARAM
#endif
	/* PORTVLAN Legacy APIs */
#ifdef IN_PORTVLAN
#ifndef IN_PORTVLAN_MINI
#define PORTVLAN_LEGACY_API \
...
#define PORTVLAN_LEGACY_API_PARAM \
...
#define ACL_LEGACY_API_PARAM
#endif
	/* PORTCTRL Legacy APIs */
#ifdef IN_PORTCONTROL
#ifndef IN_PORTCONTROL_MINI
#define PORTCONTROL_LEGACY_API \
...
#define PORTCONTROL_LEGACY_API_PARAM \
...
/*qca808x_end*/\
    ...
    IPMC_API_PARAM \
    CROSSCHIP_API_PARAM \
    TRUNK_LEGACY_API_PARAM \
    SEC_LEGACY_API_PARAM \
    PPPOE_LEGACY_API_PARAM \
    MISC_LEGACY_API_PARAM \
    QOS_LEGACY_API_PARAM \
    PORTVLAN_LEGACY_API_PARAM \
    FDB_LEGACY_API_PARAM \
    ACL_LEGACY_API_PARAM \
    PORTCONTROL_LEGACY_API_PARAM \
/* auto_insert_flag_2 */ \
/*qca808x_start*/\
