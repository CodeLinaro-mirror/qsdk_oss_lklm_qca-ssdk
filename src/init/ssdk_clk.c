...
static struct rst_data_t mppe_rst_tbl[] = {
       ...
       RST_LOOKUP(0x17098, GCC_NODE_NAME, GCC_UNIPHY0_PMA_BCR, RST_BIT0),
       RST_LOOKUP(0x1709c, GCC_NODE_NAME, GCC_UNIPHY1_PMA_BCR, RST_BIT0),
       RST_LOOKUP(0x170a0, GCC_NODE_NAME, GCC_UNIPHY2_PMA_BCR, RST_BIT0),
       ...
       RST_LOOKUP(0x17060, GCC_NODE_NAME, GCC_UNIPHY1_XLGPCS_ARES, BIT(1)),
       RST_LOOKUP(0x17070, GCC_NODE_NAME, GCC_UNIPHY2_XLGPCS_ARES, BIT(1)),
...
static char *ppe_rst_ids[UNIPHY_RST_MAX] = {
	...
	UNIPHY0_PMA_RESET_ID,
	UNIPHY1_PMA_RESET_ID,
	UNIPHY2_PMA_RESET_ID,
};
