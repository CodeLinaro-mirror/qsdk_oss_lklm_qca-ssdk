...
hmsppe_service_code_mapping_service_code_get(
		...
		a_uint32_t *value)
{
	union service_code_mapping_u reg_val;
	sw_error_t ret = SW_OK;

	ret = hmsppe_service_code_mapping_get(dev_id, index, &reg_val);
	*value = reg_val.bf.service_code;
	return ret;
}
		...
		a_uint32_t value)
{
	...
	if (SW_OK != ret)
		return ret;
	reg_val.bf.service_code = value;
	ret = hmsppe_service_code_mapping_set(dev_id, index, &reg_val);
	return ret;
}
		...
		a_uint32_t *value)
{
	...
	ret = hmsppe_service_code_mapping_get(dev_id, index, &reg_val);
	*value = reg_val.bf.service_code_valid;
	return ret;
}
		...
		a_uint32_t value)
{
	...
	if (SW_OK != ret)
		return ret;
	reg_val.bf.service_code_valid = value;
	ret = hmsppe_service_code_mapping_set(dev_id, index, &reg_val);
	return ret;
}
...
{
	if (index >= PORT_MAPPING_TBL_MAX_ENTRY)
		return SW_OUT_OF_RANGE;
	return hppe_reg_get(
				dev_id,
				PRX_BASE_ADDR + PORT_MAPPING_TBL_ADDRESS + \
				index * PORT_MAPPING_TBL_INC,
				&value->val);
}
...
hmsppe_port_mapping_tbl_dst_info_get(
		...
		a_uint32_t *value)
{
	union port_mapping_tbl_u reg_val;
	sw_error_t ret = SW_OK;

	ret = hmsppe_port_mapping_tbl_get(dev_id, index, &reg_val);
	*value = reg_val.bf.dst_info;
	return ret;
}
		...
		a_uint32_t value)
{
	...
	if (SW_OK != ret)
		return ret;
	reg_val.bf.dst_info = value;
	ret = hmsppe_port_mapping_tbl_set(dev_id, index, &reg_val);
	return ret;
}
