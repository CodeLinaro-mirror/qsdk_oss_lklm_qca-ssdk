		...
		fal_port_t port_id, fal_port_isol_ctrl_t *isol_ctrl)
{
...
#if defined(JHPPE)
	return adpt_jhppe_port_isol_ctrl_set(dev_id, port_id, isol_ctrl);
#endif
	...
	l2_vp_port_tbl.bf.isol_profile = isol_ctrl->isol_group_id;
		...
		fal_port_t port_id, fal_port_isol_ctrl_t *isol_ctrl)
{
...
#if defined(JHPPE)
	return adpt_jhppe_port_isol_ctrl_get(dev_id, port_id, isol_ctrl);
#endif
	...
	isol_ctrl->isol_group_id = l2_vp_port_tbl.bf.isol_profile;
