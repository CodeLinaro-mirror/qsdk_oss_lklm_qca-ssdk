...
{
	switch(type) {
	case FAL_TUNNEL_PROGRAM_TYPE_0:
		*program_id = 0;
		break;
	case FAL_TUNNEL_PROGRAM_TYPE_1:
		*program_id = 1;
		break;
	case FAL_TUNNEL_PROGRAM_TYPE_2:
		*program_id = 2;
		break;
	case FAL_TUNNEL_PROGRAM_TYPE_3:
		*program_id = 3;
		break;
	case FAL_TUNNEL_PROGRAM_TYPE_4:
		*program_id = 4;
		break;
